...
const StockDashboardContent = memo(({
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-10 duration-1000">
            ...
            <div className="sticky top-0 z-40 justify-between bg-background/95 backdrop-blur-xl py-5 flex items-center gap-4 border-b border-black/5 dark:border-white/10 transition-all duration-500 group/sticky shadow-sm -mx-10 px-10">
