        ...
        <div ref={containerRef} className="relative w-full max-w-sm group/search">
            <form onSubmit={pressSearchButton} className="flex gap-3 w-full">
                <div className={cn(
                    ...
                    <Search className={cn(
                        "absolute left-4 top-1/2 -translate-y-1/2 size-4",
                ...
                <Button
                    type="submit"
                    className={cn(
                        "h-12 px-8 rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl shadow-blue-500/10",
            ...
            {isFocused && recentSearchList.length > 0 && (
                <div className="absolute top-full left-0 w-full z-50 mt-4 bg-slate-50/95 dark:bg-card/95 backdrop-blur-md border border-black/5 dark:border-white/10 shadow-xl rounded-3xl overflow-hidden">
                    ...
                    <ScrollArea className="h-[280px]">
                        <div className="p-4 space-y-1">
                            {recentSearchList.map((v) => (
                                <div
                                    key={v}
                                    className="group/item flex items-center justify-between px-4 py-3.5 rounded-[1.25rem] hover:bg-black/5 dark:hover:bg-white/5 cursor-pointer border border-transparent hover:border-black/5 dark:hover:border-white/5"
