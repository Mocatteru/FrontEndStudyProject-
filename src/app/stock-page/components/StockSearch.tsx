...
export default function StockSearchInput() {
    ...
    return (
        <div className="relative w-full max-w-sm group/search">
                ...
                <div className={cn(
                    ...
                    <Input
                        ...
                        className={cn(
                            ...
                            "placeholder:text-muted-foreground/50 placeholder:font-black placeholder:uppercase placeholder:tracking-widest placeholder:text-[10px]"
                        )}
            ...
            {/* 최근 검색기록 드롭다운 - [Contrast Refactoring] */}
            {isFocused && recentSearchList.length > 0 && (
                <div className="absolute top-full left-0 w-full z-50 mt-4 p-4 bg-card/95 backdrop-blur-2xl border border-black/5 dark:border-white/10 shadow-2xl rounded-3xl animate-in fade-in zoom-in-95 slide-in-from-top-4 duration-300">
                    <div className="flex items-center justify-between px-3 py-2 mb-4">
                        ...
                        <Button
                            variant="ghost"
                            size="sm"
                            className="h-7 px-3 text-[10px] font-black border-none bg-red-500/10 hover:bg-red-500/20 text-red-500 transition-all rounded-full uppercase tracking-tighter"
