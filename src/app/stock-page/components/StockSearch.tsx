    ...
    return (
        <div ref={containerRef} className="relative w-full max-w-sm group/search">
            ...
            {isFocused && recentSearchList.length > 0 && (
                <div className="absolute top-full left-0 w-full z-50 mt-4 bg-card/95 backdrop-blur-md border border-black/5 dark:border-white/10 shadow-xl rounded-3xl overflow-hidden">
